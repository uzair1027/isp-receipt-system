...
function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-60 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 z-50 flex flex-col shadow-2xl shadow-black/20">
      {/* Logo */}
      <Link to="/dashboard" className="flex items-center gap-3 h-16 px-5 border-b border-white/5">
      ...
      <div className="p-4 border-t border-white/5">
        ...
        <button onClick={logout} className="w-full mt-3 px-3 py-1.5 text-xs text-slate-400 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors text-left">
          Sign Out
        </button>
      </div>
    </aside>
